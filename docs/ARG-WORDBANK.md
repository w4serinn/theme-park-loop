...
- エルンスト・フォン・アルノルド卿(学院創設者フルネーム、魔法暦1073年創立)
  → 2026-07-30、「アルノルド卿の丘」駅・大蒸留器「琥珀の心臓」とグルーピングし
  `pages/glossary/arnold-namesake.html`[P44]として使用済み
- 魔導機械科(「アルノルド卿直系の学科」。学院の心臓部とも言える大時計塔の管理を
  一手に担う、5学科の中でも特別な位置づけ)
- 「アルノルド卿の丘」駅(魔導鉄道・幻路線の最寄り駅名)→ 2026-07-30、P44として使用済み
...
- 珍薬草「月草」(groceries.html。満月の夜のみ採取可能。他多数ページにも出現、
  下記5節参照)
- ドックのシンボルマーク「碇と羽根」(airship-gear.html)→ 2026-07-30、P47として使用済み
