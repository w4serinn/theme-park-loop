...
| 魔導機械科 | index.html | 1. トップページ | — | 使用済み | P104 |
...
| エルダーフラワー | dining/index.html 他3ページ | 5. 学食・喫茶室 | — | 使用済み | P62 |
| 写本師 | dining/library-dining.html | 5. 学食・喫茶室 | (未分類、関連) | 使用済み(関連) | P35 |
| 安息薬草/安息草 | dining/index.html・alchemy-dining.html | 5. 学食・喫茶室 | — | 使用済み | P62 |
...
| 見習い案内人 | tickets/index.html | 6. 入学願書 | — | 使用済み | P106 |
| 学院東駐車場 | access/index.html | 7. 学院への道のり | — | 使用済み | P108 |
